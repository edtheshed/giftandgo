...
class FileProcessorServiceTest {
    ...
    private val fileProcessorService: FileProcessorService =
        ValidatingFileProcessorService(
            personParser,
            validator,
        )

    @Test
    fun `should process correct file`() {
    ...
    @Test
    fun `should show error for broken file`() {
        val exception =
            assertFailsWith<ParseAggregateException> {
    ...
    @Test
    fun `should show errors for invalid file`() {
        val exception =
            assertFailsWith<ValidationAggregateException> {
    ...
    @Test
    fun `relaxed file processor should not validate`() {
