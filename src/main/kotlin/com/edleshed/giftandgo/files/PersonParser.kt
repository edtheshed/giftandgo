    ...
    internal fun parseOrThrow(line: String): Person {
        ...
        val uuid =
            try {
                ...
                throw ParseException("invalid UUID")
            }
...
fun String.toDouble(field: String): Double = toDoubleOrNull() ?: throw ParseException("$field must be a number")
